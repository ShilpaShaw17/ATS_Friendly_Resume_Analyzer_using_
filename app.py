...
input_prompt1 = """
Imagine you are a technical recruiter tasked with evaluating a candidate's resume for a technical role. 
Your objective is to provide a comprehensive assessment of how well the applicant's skills and experience match the job requirements.
Highlight areas where the candidate excels and areas that may need improvement in the specified role.
"""
